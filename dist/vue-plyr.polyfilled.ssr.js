...
function () {
  return this;
}() || Function('return this')();var TypeError$1 = global_1.TypeError; // `RequireObjectCoercible` abstract operation
...
var useSymbolAsUid = nativeSymbol && !Symbol.sham && typeof Symbol.iterator == 'symbol';var Object$2 = global_1.Object;
...
};var isPure = false;var defineProperty = Object.defineProperty;
...
} : Object$3;var toIndexedObject = function (it) {
...
};var hiddenKeys = {};var OBJECT_ALREADY_INITIALIZED = 'Object already initialized';
...
var objectGetOwnPropertyNamesExternal = {
  f: f$5
};var arraySlice = functionUncurryThis([].slice);var f$6 = wellKnownSymbol;
...
hiddenKeys[HIDDEN] = true;var SPECIES$1 = wellKnownSymbol('species');
...
handlePrototype(domTokenListPrototype);function _defineProperty(obj, key, value) {
  if (key in obj) {
...
if (descriptors && isCallable(NativeSymbol) && (!('description' in SymbolPrototype$1) || // Safari 12 bug
...
addToUnscopables(FIND_INDEX);var iteratorClose = function (iterator, kind, value) {
...
};var Array$3 = global_1.Array; // `Array.from` method implementation
...
var FORCED$2 = NEGATIVE_ZERO$1 || !STRICT_METHOD$4; // `Array.prototype.lastIndexOf` method implementation
...
});var TypeError$b = global_1.TypeError; // `Array.prototype.{ reduce, reduceRight }` methods implementation
...
};var engineIsNode = classofRaw(global_1.process) == 'process';var $reduce = arrayReduce.left;
...
var STRICT_METHOD$6 = arrayMethodIsStrict('some'); // `Array.prototype.some` method
// https://tc39.es/ecma262/#sec-array.prototype.some
...
});var RangeError = global_1.RangeError; // `String.prototype.repeat` method implementation
...
var push$3 = functionUncurryThis([].push); // `Object.{ entries, values }` methods implementation
...
};var TypeError$g = global_1.TypeError; // `RegExpExec` abstract operation
...
fixRegexpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
    ...
    internalSplit = function (separator, limit) {
      ...
      while (match = functionCall(regexpExec, separatorCopy, string)) {
        ...
        if (lastIndex > lastLastIndex) {
          push$5(output, stringSlice$8(string, lastLastIndex, match.index));
      ...
      } else push$5(output, stringSlice$8(string, lastLastIndex));
  ...
  function (string, limit) {
    ...
    while (q < S.length) {
      ...
      if (z === null || (e = min$5(toLength(splitter.lastIndex + (UNSUPPORTED_Y$3 ? q : 0)), S.length)) === p) {
        q = advanceStringIndex(S, q, unicodeMatching);
      } else {
        push$5(A, stringSlice$8(S, p, q));
    ...
    push$5(A, stringSlice$8(S, p));
    return A;
  }];
}, !SPLIT_WORKS_WITH_OVERWRITTEN_EXEC, UNSUPPORTED_Y$3);var getOwnPropertyDescriptor$3 = objectGetOwnPropertyDescriptor.f; // eslint-disable-next-line es/no-string-prototype-startswith -- safe
...
handlePrototype$1(domTokenListPrototype, 'DOMTokenList');var ITERATOR$6 = wellKnownSymbol('iterator');
...
var stringPunycodeToAscii = function (input) {
  var encoded = [];
  var labels = split$1(replace$5(toLowerCase(input), regexSeparators, '\u002E'), '.');
  var i, label;
...
var arraySort = mergeSort;var ITERATOR$7 = wellKnownSymbol('iterator');
...
var URLSearchParamsState = function (init) {
  ...
  if (init !== undefined) {
    if (isObject(init)) this.parseObject(init);else this.parseQuery(typeof init == 'string' ? charAt$6(init, 0) === '?' ? stringSlice$a(init, 1) : init : toString_1(init));
  }
};
      ...
      switch (state) {
        ...
        case FILE_SLASH:
          ...
          if (base && base.scheme == 'file' && !startsWithWindowsDriveLetter(join$2(arraySliceSimple(codePoints, pointer), ''))) {
            if (isWindowsDriveLetter(base.path[0], true)) push$8(url.path, base.path[0]);else url.host = base.host;
          }
...
defineWellKnownSymbol('replace');function _typeof(obj) {
...
}, collectionStrong);var FAILS_ON_PRIMITIVES$3 = fails(function () {
...
var functionBind = Function$1.bind || function bind(that
/* , ...args */
) {
...
var push$9 = [].push; // `Reflect.construct` method
...
_export({
  ...
  /* , newTarget */
    ...
    if (Target == newTarget) {
      ...
      var $args = [null];
      functionApply(push$9, $args, args);

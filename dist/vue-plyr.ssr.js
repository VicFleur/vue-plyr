...
var URLSearchParamsState = function (init) {
  ...
  if (init !== undefined) {
    if (isObject(init)) this.parseObject(init);else this.parseQuery(typeof init == 'string' ? charAt$6(init, 0) === '?' ? stringSlice$9(init, 1) : init : toString_1(init));
  }
};
...
NativeSymbol().description !== undefined)) {
  ...
  defineProperty$8(SymbolPrototype$1, 'description', {
    ...
    get: function description() {
      ...
      var desc = NATIVE_SYMBOL ? stringSlice$b(string, 7, -1) : replace$7(string, regexp, '$1');
...
defineWellKnownSymbol('replace');// https://tc39.es/ecma262/#sec-symbol.iterator
